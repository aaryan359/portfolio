...
export default function Contact() {
  ...
  <form className="relative my-4" onSubmit={subscribe}>
    ...
    />
    <button
  className="flex items-center justify-center absolute right-1 top-1 px-2 md:px-4 font-bold h-8 bg-green-400 dark:bg-green-400 text-gray-900  rounded w-20 md:w-28 text-sm md:text-base"
  type="submit"
